...
<html lang="en">
    <head>
        ...
        <meta content="Solusi tepercaya untuk memenuhi semua kebutuhan usaha Anda. Lewat ribuan produk segar terbaik yang dapat disesuaikan dengan kebutuhan usaha serta didukung oleh ekosistem logistik dan penyimpanan yang mutakhir, Pratama Aulia Jaya berkomitmen untuk mewujudkan potensi usaha Anda menjadi hasil nyata." name="description">
        <meta content="{{ $title ?? 'App Toko' }}" name="keywords">
        <meta property="og:locale" content="ID_id"/>
        <meta property="og:type" content="website"/>
        <meta property="og:image" content="{{ asset('assets/img/paj.png') }}">
        <!-- Bootstrap CSS -->
        <link rel="shortcut icon" href="{{ asset('assets/img/paj.png') }}">
